package com.floofyplasma.stationapi.api.client.color.world;

import net.minecraft.block.Block;
import net.minecraft.class_334;
import net.minecraft.util.math.BlockPos;
import net.minecraft.world.BlockView;
import com.floofyplasma.stationapi.api.client.world.ColorResolver;
import com.floofyplasma.stationapi.mixin.render.client.WaterColorAccessor;
