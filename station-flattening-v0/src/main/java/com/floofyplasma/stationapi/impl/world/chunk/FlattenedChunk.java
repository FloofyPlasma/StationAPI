...
import com.floofyplasma.stationapi.api.event.world.BlockSetEvent;
import com.floofyplasma.stationapi.api.event.world.MetaSetEvent;
import com.floofyplasma.stationapi.api.util.math.MutableBlockPos;
import com.floofyplasma.stationapi.mixin.flattening.ChunkAccessor;
...
public class FlattenedChunk extends Chunk {
    ...
    public void fromLegacy(byte[] tiles) {
        ...
        int offsetZ = mask == 127 ? 7 : com.floofyplasma.stationapi.api.util.math.MathHelper.ceilLog2(mask + 1);
