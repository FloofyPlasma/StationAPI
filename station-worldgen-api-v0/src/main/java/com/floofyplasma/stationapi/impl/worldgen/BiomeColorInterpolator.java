...
import com.floofyplasma.stationapi.api.worldgen.biome.BiomeColorProvider;
...
public class BiomeColorInterpolator {
    ...
    private int lerp(int a, int b, float delta) {
        ...
        r1 = com.floofyplasma.stationapi.api.util.math.MathHelper.lerp(delta, r1, r2);
        g1 = com.floofyplasma.stationapi.api.util.math.MathHelper.lerp(delta, g1, g2);
        b1 = com.floofyplasma.stationapi.api.util.math.MathHelper.lerp(delta, b1, b2);
