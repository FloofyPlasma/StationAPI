...
public class BiomeDataInterpolator {
    ...
    public float get(class_519 source, int x, int z) {
        ...
        float a = com.floofyplasma.stationapi.api.util.math.MathHelper.lerp(dx, data[0], data[1]);
        float b = com.floofyplasma.stationapi.api.util.math.MathHelper.lerp(dx, data[2], data[3]);

        return com.floofyplasma.stationapi.api.util.math.MathHelper.lerp(dz, a, b);
    }
