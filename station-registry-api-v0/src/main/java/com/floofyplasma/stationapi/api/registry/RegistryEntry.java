...
public interface RegistryEntry<T> {
    ...
    class Reference<T> implements RegistryEntry<T> {
        ...
        private Reference(RegistryEntry.Reference.Type referenceType, RegistryEntryOwner<T> owner, int reservedRawId, @Nullable RegistryKey<T> registryKey, @Nullable T value) {
            this.owner = owner;
        ...
        static <T> Reference<T> intrusive(RegistryEntryOwner<T> owner, int reservedRawId, @Nullable T value) {
            return new Reference<>(RegistryEntry.Reference.Type.INTRUSIVE, owner, reservedRawId, null, value);
        }
